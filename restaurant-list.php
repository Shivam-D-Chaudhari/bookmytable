          ...
          <form action="book.php" method="POST">
            ...
            <div class="col-md-12 text-center" id="menu-filters">
              <ul class="ul-menus">
                ...
                <li><a class="filter " data-filter=".wine_bar">Bar</a></li>
                <li><a class="filter " data-filter=".bio">Punjabi</a></li>
                <li><a class="filter " data-filter=".bistro_brass">Bistro</a></li>
                <li><a class="filter " data-filter=".waffles">Waffles</a></li>
                <li><a class="filter " data-filter=".world_food">Burger</a></li>
                <li><a class="filter " data-filter=".gourmet">Italian</a></li>
                <li><a class="filter " data-filter=".pizza">Pizza</a></li>
                <li><a class="filter " data-filter=".tea">Gujarati</a></li>
                <li><a class="filter " data-filter=".traditional">Mexican</a></li>
